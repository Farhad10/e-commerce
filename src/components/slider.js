  ...
  return (
    <>
      ...
      >
        ...
        <Image width={1000} height={500} src="/images/shop3.jpeg" alt="Your Image" className="w-full" />
...
<Button text="Shop Now" />
             ...
             <SwiperSlide>
        <div className="relative">
        <Image width={1000} height={500} src="/images/shop2.avif" alt="Your Image" className="w-full" />
...
<Button text="Shop Now" />
             ...
             <SwiperSlide>
        <div className="relative">
        <Image width={1000} height={500} src="/images/shop.webp" alt="Your Image" className="w-full" />
